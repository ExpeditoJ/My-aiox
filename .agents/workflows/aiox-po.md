...
1. Leia a definição completa do agente em `.aiox-core/development/agents/po.md`
2. Siga as `activation-instructions` do bloco YAML contido no arquivo
3. Renderize o greeting via: `node .aiox-core/development/scripts/generate-greeting.js po`
